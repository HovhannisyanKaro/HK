...
/**
 * Created by Hovhannisyan.Karo on 01.12.2017.
 */

public abstract class StickerView extends FrameLayout {

    public static final String TAG = "STICKER_VIEW_TAG";
    ...
    private void init(Context context){
        ...
        this.iv_scale.setImageResource(R.drawable.ic_st_zoom);
        this.iv_delete.setImageResource(R.drawable.ic_st_remove);
//        this.iv_flip.setImageResource(R.drawable.flip);
    ...
    private class BorderView extends View{
        ...
        protected void onDraw(Canvas canvas) {
            ...
            borderPaint.setStrokeWidth(9f);
            borderPaint.setColor(Color.parseColor("#ffa7a7"));
            borderPaint.setStyle(Paint.Style.STROKE);
            borderPaint.setPathEffect(new DashPathEffect(new float[] {30,30}, 0));
